...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
	...
	protected TextView mMoreText; // Button to expand/collapse
	...
	public void setollapsedStatus(SparseBooleanArray status){
		this.mCollapsedStatus = status;
	}

	@Override
	public void onClick(View view) {
		if (mMoreText.getVisibility() != View.VISIBLE) {
			return;
		}

		mCollapsed = !mCollapsed;

		//mMoreText.setImageDrawable(mCollapsed ? mExpandDrawable : mCollapseDrawable);
	...
	public void setText(@Nullable CharSequence text, @NonNull SparseBooleanArray collapsedStatus, int position) {
		...
		//JYLog.D("isCollapsed: " + mCollapsed + "," +position ,new Throwable());
...
//		}
	...
	private void findViews() {
		...
		mMoreText = (TextView) findViewById(R.id.expand_collapse);
		//mMoreText.setImageDrawable(mCollapsed ? mExpandDrawable : mCollapseDrawable);
