 ...
 */
public class ProfileDetailAct_back_0429 extends ParentAct implements View.OnClickListener, AdapterItemClickListener {
	...
	public void onAdapterItemClick(View v, int position) {
		...
		switch (v.getId()) {
			...
			case R.id.layout_follower:
				...
				intent.putExtra(INTENT_KEY.USER_TYPE, Definitions.USER_LIST_TYPE.FOLLOWER);
				intent.putExtra(INTENT_KEY.MEMB_ID, membId);
				Util.moveActivity(this, intent, -1, -1, false, false);
				break;
			case R.id.layout_following:
				intent = new Intent(this, UserListAct.class);
				intent.putExtra(INTENT_KEY.USER_TYPE, Definitions.USER_LIST_TYPE.FOLLOWING);
				intent.putExtra(INTENT_KEY.MEMB_ID, membId);
				Util.moveActivity(this, intent, -1, -1, false, false);
				break;
		...
		builder.setItems(etcs, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				if (which == 0) {
					...
					Intent intent = new Intent(ProfileDetailAct_back_0429.this, BridgeAct.class);
					intent.putExtra(INTENT_KEY.DATA, GOTO.REPORT);
					intent.putExtra(INTENT_KEY.MEMB_ID, membId);
					Util.moveActivity(ProfileDetailAct_back_0429.this, intent, -1, -1, false, false);
					//TODO 신고하기
