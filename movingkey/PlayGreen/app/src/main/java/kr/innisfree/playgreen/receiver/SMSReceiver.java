...
/**
 * Created by jooyoung on 2016-01-27.
 */
        ...
        if (intent.getAction().equals(
            ...
            if (bundle != null) {
                ...
                for (int i = 0; i < pdusObj.length; i++) {
                    ...
                    // 데이터를 message에 담는다 이 때 pdusObj는 byte배열로 형변환을 해줘야 함
                }
                ...
                if (matcher.find()) {
                    ...
                    Intent i = new Intent();
                    i.setAction("com.airrabbit.authnumber_receive");
                    i.putExtra("auth_number", authNumber);
