...
//                        previewSize = newSize;
//
//                        JYLog.D("TAG::1.onMeasure::getWidth::::::" + previewSize.width, new Throwable());
//                        JYLog.D("TAG::1.onMeasure::getHeight::::::" + previewSize.height, new Throwable());
    ...
    public void takePicture(final PictureTransaction xact) {
        if (inPreview) {
            if (isAutoFocusing) {
                ...
                JYLog.D("TAG::pictureSize::width::1::" + pictureSize.width, new Throwable());
                JYLog.D("TAG::pictureSize::height::1::" + pictureSize.height, new Throwable());
...
//        setCameraPictureOrientation(pictureParams);
        ...
        Camera.Parameters videoParams = camera.getParameters();
        videoParams.setPreviewSize(getWidth(), getHeight());
        videoParams.setFocusMode(Camera.Parameters.FOCUS_MODE_CONTINUOUS_VIDEO);
        setCameraPictureOrientation(videoParams);
//        camera.setParameters(videoParams);
